...
1. Make an [Issue](https://github.com/ligofff/lgf-copy-serialized-action/issues/new)
...
```json
    {
        "dependencies": {
            "com.ligofff.lgf-copy-serialized-action": "https://github.com/YOUR_USER/lgf-copy-serialized-action.git"
        }
    }
```
